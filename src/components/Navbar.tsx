    ...
    >
      <div className="flex items-center justify-between h-16 max-w-5xl px-6 mx-auto">
        ...
        <div className="items-center hidden gap-8 md:flex">
          ...
          <a
            href="/final-portfolio-hussein.pdf"
            download
          ...
          >
            ...
            <svg width="11" height="11" viewBox="0 0 11 11" fill="none">
              <path d="M5.5 1v6M2 7.5l3.5 2.5L9 7.5" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </a>
        </div>
        ...
        >
          ...
          <span className={`block h-px bg-current transition-all ${menuOpen ? "w-5" : "w-3"}`} />
        </button>
      </div>
      ...
      {menuOpen && (
        <div className="md:hidden bg-[#090909]/95 backdrop-blur-md border-t border-white/5 px-6 py-4 flex flex-col gap-4">
          ...
          <a href="/cv.pdf" download className="py-1 transition-colors text-white/60 hover:text-white">
            My CV ↓
          </a>
        </div>
      )}
